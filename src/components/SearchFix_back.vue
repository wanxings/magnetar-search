...
<template>
  <div id="searchfix">
    ...
    >
      ...
      >
        <Option value="bt">磁力</Option>
        <Option value="movie">影视</Option>
        <Option value="jav">番号</Option>
        <Option value="javActress">女优</Option>
      </Select>
      <div
        v-if="imageEngine && imageQuery.id"
        slot="prefix"
        class="imageEngineblock z-icon"
      >
      ...
      <div id="zicon" slot="suffix">
        <Icon title="上传图片" @click="showUploadpane" type="md-qr-scanner" />
